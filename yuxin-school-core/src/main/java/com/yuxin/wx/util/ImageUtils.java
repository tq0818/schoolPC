...
public class ImageUtils {  
	...
	public static void resize(String srcImageFile, String result,int newWidth){
		try{

		File originalFile= new File(srcImageFile);
		File resizedFile= new File(result);
        ...
        FileImageOutputStream fileImageOutput = new FileImageOutputStream(resizedFile);  
