package com.yuxin.wx.util.smsClient.interfacej;
...
public class SmsClientSend {
	...
	public static String sendSms(String mobile, String content) {
		...
		return sendSms(CompanyInfo.URL_UTF8, CompanyInfo.USER_ID, CompanyInfo.ACCOUNT, CompanyInfo.PASSWORD, mobile, content, null,
	...
	public static void main(String[] args) {
		String res = sendSmsTwo("18032760906", "您的信息模板已经更改。【在线网校】");
