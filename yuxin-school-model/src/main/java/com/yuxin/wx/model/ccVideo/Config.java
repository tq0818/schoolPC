 ...
 **/
public class Config {
	public static String userid = "9D962C153919B4DA";
	public static String key = "7ZCRsfyU6xVIZ3fbQmuawjkqXf3PfMNM";
	
	public static Integer CHUNKSIZE = 524288; // 上传的chunk段大小，不能超过4M，默认(2*1024*1024);
