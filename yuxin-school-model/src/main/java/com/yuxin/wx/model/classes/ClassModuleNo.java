...
public class ClassModuleNo extends BaseEntity {
	...
	private String supportMobile;  //是否支持手机端
	private String liveClassType;  //展示互动直播班型  1.大讲堂  2.小班课
	
	// Constructor
	public ClassModuleNo() {
	}
	
	/**
	 * full Constructor
	 */
	public ClassModuleNo(Integer id, String name, Integer itemOneId, Integer itemSecondId, Integer moduleId, String examTerm, Date startDate, String lessonType, String lessonDay, String lessonScope, String startTime, String endTime, String lessonHour, String teachers, String masters, String assistants, Integer campusId, String classroom, String liveRoom, String device, Integer planEnrollStudents, Integer enrollYetStudents, String publishStatus, 
			Integer totalHours, String classTeachType, String description, Date createTime, Integer creator, Date updateTime, Integer updator, Integer companyId, Integer delFlag, Integer lessonTotal, Integer lessonPlan, String liveClassType ) {
		setId(id);
		this.name = name;
	...
	public ClassModuleNo setName(String name) {
		this.name = name;
		return this;
	}
	...
	public ClassModuleNo setItemOneId(Integer itemOneId) {
		this.itemOneId = itemOneId;
		return this;
	}
	...
	public ClassModuleNo setItemSecondId(Integer itemSecondId) {
		this.itemSecondId = itemSecondId;
		return this;
	}
	...
	public ClassModuleNo setModuleId(Integer moduleId) {
		this.moduleId = moduleId;
		return this;
	}
	...
	public ClassModuleNo setExamTerm(String examTerm) {
		this.examTerm = examTerm;
		return this;
	}
	...
	public ClassModuleNo setStartDate(Date startDate) {
		this.startDate = startDate;
		return this;
	}
	...
	public ClassModuleNo setStartTime(String startTime) {
		this.startTime = startTime;
		return this;
	}
	...
	public ClassModuleNo setEndTime(String endTime) {
		this.endTime = endTime;
		return this;
	}
	...
	public ClassModuleNo setTeachers(String teachers) {
		this.teachers = teachers;
		return this;
	}
	...
	public ClassModuleNo setMasters(String masters) {
		this.masters = masters;
		return this;
	}
	...
	public ClassModuleNo setAssistants(String assistants) {
		this.assistants = assistants;
		return this;
	}
	...
	public ClassModuleNo setCampusId(Integer campusId) {
		this.campusId = campusId;
		return this;
	}
	...
	public ClassModuleNo setClassroom(String classroom) {
		this.classroom = classroom;
		return this;
	}
	...
	public ClassModuleNo setLiveRoom(String liveRoom) {
		this.liveRoom = liveRoom;
		return this;
	}
	...
	public ClassModuleNo setDevice(String device) {
		this.device = device;
		return this;
	}
	...
	public ClassModuleNo setPlanEnrollStudents(Integer planEnrollStudents) {
		this.planEnrollStudents = planEnrollStudents;
		return this;
	}
	...
	public ClassModuleNo setEnrollYetStudents(Integer enrollYetStudents) {
		this.enrollYetStudents = enrollYetStudents;
		return this;
	}
	...
	public ClassModuleNo setPublishStatus(String publishStatus) {
		this.publishStatus = publishStatus;
		return this;
	}
	...
	public ClassModuleNo setTotalHours(Integer totalHours) {
		this.totalHours = totalHours;
		return this;
	}
	...
	public ClassModuleNo setClassTeachType(String classTeachType) {
		this.classTeachType = classTeachType;
		return this;
	}
	...
	public ClassModuleNo setDescription(String description) {
		this.description = description;
		return this;
	}
	...
	public ClassModuleNo setCreateTime(Date createTime) {
		this.createTime = createTime;
		return this;
	}
	...
	public ClassModuleNo setCreator(Integer creator) {
		this.creator = creator;
		return this;
	}
	...
	public ClassModuleNo setUpdateTime(Date updateTime) {
		this.updateTime = updateTime;
		return this;
	}
	...
	public ClassModuleNo setUpdator(Integer updator) {
		this.updator = updator;
		return this;
	}
