...
public class SysConfigTeacher extends BaseEntity {
...
1：已删除；0：未删除 */ 
	...
	public SysConfigTeacher setBirthday(String birthday) throws ParseException {
	...
	public SysConfigTeacher(String name, String teacherType, String sex,
			...
			Integer companyId, Integer teacherId, String resume, String headpicUrl,String educationCode) {
		super();
		this.name = name;
		this.teacherType = teacherType;
		this.sex = sex;
