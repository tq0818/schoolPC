...
public class CoursesVo extends BaseEntity {
	...
	private Integer totalNum; /* 总课时*/
	
	public CoursesVo() {
		
	}

	public CoursesVo(String name, String typeCode, Double originalPrice,
			...
			Integer liveWatchCount, Integer itemTag, String tagName,
			Integer totalNum) {
		super();
		this.name = name;
