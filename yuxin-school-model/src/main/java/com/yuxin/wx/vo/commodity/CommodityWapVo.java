...
public class CommodityWapVo extends BaseEntity{
	...
	public CommodityWapVo(){
		
	}
	
	public CommodityWapVo(Integer id, String name, String coverUrl,
	...
	public Integer getMixedFlag() {
		return mixedFlag;
	}

	public void setMixedFlag(Integer mixedFlag) {
