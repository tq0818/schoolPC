...
public class StudentListDataVo extends BaseEntity{
	...
	public StudentListDataVo() {

	}
	public StudentListDataVo(Integer id, String name, String sex,
			...
			String promoteKeyword, String userSign) {
		this.id = id;
		this.name = name;
		this.sex = sex;
