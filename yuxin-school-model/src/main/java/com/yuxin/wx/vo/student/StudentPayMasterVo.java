...
public class StudentPayMasterVo extends BaseEntity {
	...
	// Constructor
	public StudentPayMasterVo() {
	}
	
	/**
	 * full Constructor
	 */
	public StudentPayMasterVo(Integer id, Date applyTime, Integer examTermId, String examTermName, Integer itemOneId, String itemOneName, Integer itemSecondId, String itemSecondName, Integer classTypeId, String classTypeName, Integer classTypeHour, Integer stuId, Integer schoolId, Integer campusId, Integer applyPlaceId, String applyChannelCode, String payStatusCode, String bizStatusCode, String isAgent, Integer isAgentMaterialComplete, String isAgentComplete, String agentRemark, Double trainingFee, Double examAgentFee, String offerTypeCode, Double offerAmount, Double totalAmount, String paymentTypeCode, String remark, Integer relatedPayId, Date createTime, String creator, Date updateTime, String updator, Integer deleteFlag) {
		setId(id);
	...
	public StudentPayMasterVo setApplyTime(Date applyTime) {
		this.applyTime = applyTime;
		return this;
	}
	...
	public StudentPayMasterVo setExamTermId(Integer examTermId) {
		this.examTermId = examTermId;
		return this;
	}
	...
	public StudentPayMasterVo setExamTermName(String examTermName) {
		this.examTermName = examTermName;
		return this;
	}
	...
	public StudentPayMasterVo setItemOneId(Integer itemOneId) {
		this.itemOneId = itemOneId;
		return this;
	}
	...
	public StudentPayMasterVo setItemOneName(String itemOneName) {
		this.itemOneName = itemOneName;
		return this;
	}
	...
	public StudentPayMasterVo setItemSecondId(Integer itemSecondId) {
		this.itemSecondId = itemSecondId;
		return this;
	}
	...
	public StudentPayMasterVo setItemSecondName(String itemSecondName) {
		this.itemSecondName = itemSecondName;
		return this;
	}
	...
	public StudentPayMasterVo setClassTypeId(Integer classTypeId) {
		this.classTypeId = classTypeId;
		return this;
	}
	...
	public StudentPayMasterVo setClassTypeName(String classTypeName) {
		this.classTypeName = classTypeName;
		return this;
	}
	...
	public StudentPayMasterVo setClassTypeHour(Integer classTypeHour) {
		this.classTypeHour = classTypeHour;
		return this;
	}
	...
	public StudentPayMasterVo setStuId(Integer stuId) {
		this.stuId = stuId;
		return this;
	}
	...
	public StudentPayMasterVo setCampusId(Integer campusId) {
		this.campusId = campusId;
		return this;
	}
	...
	public StudentPayMasterVo setApplyPlaceId(Integer applyPlaceId) {
		this.applyPlaceId = applyPlaceId;
		return this;
	}
	...
	public StudentPayMasterVo setApplyChannelCode(String applyChannelCode) {
		this.applyChannelCode = applyChannelCode;
		return this;
	}
	...
	public StudentPayMasterVo setPayStatusCode(String payStatusCode) {
		this.payStatusCode = payStatusCode;
		return this;
	}
	...
	public StudentPayMasterVo setBizStatusCode(String bizStatusCode) {
		this.bizStatusCode = bizStatusCode;
		return this;
	}
	...
	public StudentPayMasterVo setIsAgent(String isAgent) {
		this.isAgent = isAgent;
		return this;
	}
	...
	public StudentPayMasterVo setIsAgentMaterialComplete(Integer isAgentMaterialComplete) {
		this.isAgentMaterialComplete = isAgentMaterialComplete;
		return this;
	}
	...
	public StudentPayMasterVo setIsAgentComplete(String isAgentComplete) {
		this.isAgentComplete = isAgentComplete;
		return this;
	}
	...
	public StudentPayMasterVo setAgentRemark(String agentRemark) {
		this.agentRemark = agentRemark;
		return this;
	}
	...
	public StudentPayMasterVo setTrainingFee(Double trainingFee) {
		this.trainingFee = trainingFee;
		return this;
	}
	...
	public StudentPayMasterVo setExamAgentFee(Double examAgentFee) {
		this.examAgentFee = examAgentFee;
		return this;
	}
	...
	public StudentPayMasterVo setOfferTypeCode(String offerTypeCode) {
		this.offerTypeCode = offerTypeCode;
		return this;
	}
	...
	public StudentPayMasterVo setOfferAmount(Double offerAmount) {
		this.offerAmount = offerAmount;
		return this;
	}
	...
	public StudentPayMasterVo setTotalAmount(Double totalAmount) {
		this.totalAmount = totalAmount;
		return this;
	}
	...
	public StudentPayMasterVo setPaymentTypeCode(String paymentTypeCode) {
		this.paymentTypeCode = paymentTypeCode;
		return this;
	}
	...
	public StudentPayMasterVo setRemark(String remark) {
		this.remark = remark;
		return this;
	}
	...
	public StudentPayMasterVo setRelatedPayId(Integer relatedPayId) {
		this.relatedPayId = relatedPayId;
		return this;
	}
	...
	public StudentPayMasterVo setCreateTime(Date createTime) {
		this.createTime = createTime;
		return this;
	}
	...
	public StudentPayMasterVo setCreator(String creator) {
		this.creator = creator;
		return this;
	}
	...
	public StudentPayMasterVo setUpdateTime(Date updateTime) {
		this.updateTime = updateTime;
		return this;
	}
	...
	public StudentPayMasterVo setUpdator(String updator) {
		this.updator = updator;
		return this;
	}
	...
	public StudentPayMasterVo setDeleteFlag(Integer deleteFlag) {
		this.deleteFlag = deleteFlag;
		return this;
	}
