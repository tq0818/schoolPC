...
public class WeichatUser {
	...
	public WeichatUser(String openid, String nickname, int sex, String province, String city, String country,
	...
	public String toString() {
		return "WeichatUser [openid=" + openid + ", nickname=" + nickname + ", sex=" + sex + ", province=" + province
