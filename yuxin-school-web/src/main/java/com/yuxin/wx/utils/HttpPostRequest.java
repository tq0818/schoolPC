...
public class HttpPostRequest {
     ...
     * @throws Exception
     */
    public static String getQN(String urlStr,String ak) throws Exception{
        HttpURLConnection conn = null;
        try{
            //创建URL对象
            URL url = new URL(urlStr);
            ...
            //设置通用的请求属性
            setHttpUrlConnection(conn, GET);
            conn.setRequestProperty("Authorization", ak);
            //建立实际的连接
            conn.connect();
            //获取响应的内容
            return readResponseContent(conn.getInputStream());
     ...
     * @throws Exception 
     */
    public static String postQN(String urlStr, Map<String, Object> paramMap,String ak) throws Exception{
        HttpURLConnection conn = null;
        PrintWriter writer = null;
        try{
            //创建URL对象
     ...
     * @throws Exception 
     */
    public static String postAK(String urlStr, Map<String, Object> paramMap) throws Exception{
        HttpURLConnection conn = null;
        PrintWriter writer = null;
        try{
            //创建URL对象
