package com.yuxin.wx.utils.smsClient.interfacej;

import java.net.URLEncoder;

import javax.servlet.http.HttpServletRequest;

import com.yuxin.wx.utils.SmslogUtil;
import com.yuxin.wx.utils.smsClient.companyInfo.CompanyInfo;
import com.yuxin.wx.utils.smsClient.tool.SmsClientAccessTool;
...
public class SmsClientSend {
	 ...
	 */
	public static String sendSms(HttpServletRequest request,String mobile
			, String content,Integer uid,String businessType) {

		return sendSms(request,CompanyInfo.URL_UTF8, CompanyInfo.USER_ID
				, CompanyInfo.ACCOUNT, CompanyInfo.PASSWORD, mobile, content
				, null,null, null, null, null, null, null, "POST", "UTF-8"
				, "UTF-8",uid,businessType);
	}
	...
	private static String sendSms(HttpServletRequest request,String url, String userid, String account,
			...
			,Integer uid,String businessType) {
		String result = "";
		try {
			...
			SmslogUtil.setSmsLog(request, mobile, content
					, businessType, sendStatus, uid);
			return result;
		} catch (Exception e) {
			e.printStackTrace();
			String sendStatus = "未发送，编码异常";
			SmslogUtil.setSmsLog(request, mobile, content
					, businessType, sendStatus, uid);
			return sendStatus;
		}
	...
	public static void main(String[] args) {
		String res = sendSmsTwo(null,"17600818084", "您的信息模板已经更改。【在线网校】",0, "fefe");
