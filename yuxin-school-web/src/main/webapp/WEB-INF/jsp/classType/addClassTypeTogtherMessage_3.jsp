...
<%@include file="/decorators/import.jsp" %>
    ...
    <script type="text/javascript">
	    //返回按钮
		function backReturn(){
			$("#Forms").attr("action",rootPath+"/classType/updateClassTypeMessage").submit();
		}
    	function guid() {
...
<form id="Forms" method="post">
	...
	<input type="hidden" name="oneId" value="${itemOneId }"/>
	<input type="hidden" name="type1" value="${type2 }"/>
