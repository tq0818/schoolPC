...
<form id="Forms" method="post">
	...
	<input type="hidden" id="oneId" value="${itemOneid }"/>
	<input type="hidden" name="type2" value="update"/>
	<input type="hidden" name="lable" value="${lable }"/>
	<input type="hidden" name="faceFlag" value="${ct.faceFlag }"/>
	<input type="hidden" name="liveFlag" value="${ct.liveFlag }"/>
	<input type="hidden" name="videoFlag" value="${ct.videoFlag }"/>
</form>
<jsp:include page="/WEB-INF/jsp/menu/menu_class.jsp"></jsp:include>
<form method="post" id="myForm">
	<input type="hidden" name="id" value="${classTypeId }"/>
	<input type="hidden" id="itemOneid" value="${itemOneid }"/>
	<input type="hidden" name="type2" id="type3" value="${type2 }"/>
                 ...
                 <p class="c">
                    ...
                    <span class="c-content">
                        <select name="teacherId" id="teacherList" style="width:100px;">
                           ...
                           <c:if test="${isFuShengPaikeTeac != null && isFuShengPaikeTeac }">
                           <option value="${configTeacher.id }" selected="selected">${configTeacher.name }</option>
                           </c:if>
                        </select>
