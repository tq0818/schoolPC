...
<%@include file="/decorators/import.jsp" %>
    ...
    <script type="text/javascript">
    	function backReturn(){
    		$("#myForms").attr("action",rootPath+"/classType/editClassTypeMessage").submit();
    	}
    	function guid() {
...
<form method="post" id="myForms">
	...
	<input type="hidden" name="type" value="${type2==null?'update':type2 }"/>
</form>
    ...
    <div class="heading">
        ...
        <div class="teacher-content">
            <div class="teacher-btns">
            	...
            	<input type="hidden" id="itemSecondId" value="${itemSecondId}" />
            	<input type="hidden" id="classTypeId" value="${classTypeId}" />
            	<input type="hidden" id="classTypeName" value="${moduleName }"/>
                <a href="javascript:;" class="btn btn-mini btn-default btn-add-class"><i class="iconfont">&#xe61c;</i>新增章节</a>
...
<div class="layer-tips-content add-layer w1200 class-resource none" id="class-resource">
        ...
        <div class="layer-content clear">
            ...
            <div class="term-herv">
               ...
               <span class="upfile">
				   <input type="file" lecid="" id="doctype" url="" style="border:none;"　mark="" cname="" name="doc" class="up-input" accept=".doc,.pdf,.xls,.ppt,.docx,.pptx,.xlsx,.zip,.rar" onchange="javascript:docChange();">
    ...
    <script type="text/javascript" src="<%=rootPath%>/javascripts/class/teach/videoAddBase.js"></script>
    <script type="text/javascript" src="<%=rootPath%>/javascripts/ajaxfileupload.js"></script>
</body>
</body>
</html>