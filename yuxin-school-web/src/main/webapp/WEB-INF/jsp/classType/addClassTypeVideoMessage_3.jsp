		...
		function save(mark) {
			...
			$.ajax({
						...
						success : function(data) {
						  if(mark=="save"){
							  $("#myForm").attr("action",rootPath+"/classType/onSale").submit();  
						   }else{
							  $("#marktype").val(mark);
...
<form method="post" id="myForm">
	...
	<input type="hidden" name="lable" id="labId" value="${lable }"/>
        ...
        <div class="c-main">
            <div class="c-content">
                ...
                <p class="c text-center" style="margin-top: 10px;">
                    ...
                    <a href="javascript:save('saveandtui');" class="btn btn-primary">保存</a>
                    <a href="javascript:save('save');" class="btn btn-primary">开始招生</a>
