...
<form action="<%=rootPath %>/branchSchool/queryData" id="DataForm" method="post">
...
<script type="text/javascript" src="<%=rootPath %>/javascripts/class/manageStu/StudentManage.js"></script>
