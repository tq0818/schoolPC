        ...
        <div class="c-main">
            <div class="c-content">
                ...
                <p class="c">
                    ...
                    <span class="c-content">
                        <c:choose>
                        	<c:when test="${ct.isMicroClass != 1}">回放课程</c:when>
                        	<c:when test="${ct.isMicroClass == 1}">微课</c:when>
                        </c:choose>
                    </span>
                </p>
                <p class="c">
                ...
                <p class="c setting">
                 ...
                 <p class="c">
                    ...
                    <span class="c-content"><input name="courseNum" class="readonly" type="text" value="${courseNum==null?'0':courseNum }" class="courseNum" readonly></span>
                </p>
                 <p class="c">
