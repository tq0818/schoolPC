...
<div class="u-wrap company overflow">
    ...
    <div class="mainbackground nopadding" style="min-height: 546px;">
        <div class="heading" data-protocolconfig="${courseProtocolConfig}">
            <h2 class="h5">学员列表</h2>
...
<script type="text/javascript" src="<%=rootPath %>/javascripts/class/branchschool/studentlist-full.js"></script>
