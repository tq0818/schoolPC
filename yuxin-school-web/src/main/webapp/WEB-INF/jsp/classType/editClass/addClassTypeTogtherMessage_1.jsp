            ...
            <div class="c-content">
                ...
                <p class="c">
                    ...
                    <span class="c-content">
                        <c:choose>
                    		<c:when test="${!empty firstItems }">
                    			 <select name="itemSecondId" id="itemSecondList"></select>
                    		</c:when>
                    		<c:otherwise>
                ...
                <p class="c">
                    ...
                    <c:choose>
                    	<c:when test="${empty classType.originalPrice }">
                    		<input id="prices" name="originalPrice"  class="prices" type="text"><sb>*</sb>
                    	</c:when>
                    	<c:otherwise>
                ...
                <p class="c setting">
                    ...
                    <span class="c-content"><input name="validityDay" class="settingcount" type="text" value="${classType.validityDay }"><span class="errorHtml"  mark="daycount"></span></span>
                </p>
                <p class="c setting">
                     <span class="c-title">直播观看次数</span>
                    <span class="c-content"><input name="liveWatchCount" class="settingcount" type="text" value="${classType.liveWatchCount }"><span class="errorHtml"  mark="livecount"></span></span>
                </p>
                <p class="c setting">
                     <span class="c-title">视频观看次数</span>
                    <span class="c-content"><input name="videoWatchCount" class="settingcount" type="text" value="${classType.videoWatchCount }"><span class="errorHtml" mark="videocount"></span></span>
                </p>
                 <p class="c">
                    <span class="c-title">授课方式</span>
                    <span class="c-content">
                    	<a href="javascript:;" ids="togther" id="lableType" class="btn btn-mini btn-success }">混合</a>
                    </span>
                </p>
               <p class="c">
...
<script type="text/javascript" src="<%=rootPath %>/javascripts/class/editClass/addClassTypeBaseInfo.js"></script>
