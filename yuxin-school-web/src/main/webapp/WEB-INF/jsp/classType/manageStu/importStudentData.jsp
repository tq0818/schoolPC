...
<!-- 		        </div> -->
		...
		<div style="text-align: center;"><a href="javascript:;" class="btn btn-primary signUpMany">批量报名</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=rootPath %>/manageStudent/importStudents/${classType.id }/${lable }" class="btn btn-primary">继续导入</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=rootPath %>/classStu/studentList/${classType.id }/${lable }" class="btn btn-primary">返回</a></div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="<%=rootPath %>/javascripts/class/manageStu/importlist.js"></script>
