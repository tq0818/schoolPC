...
<!-- 		        </div> -->
		...
		<div style="text-align: center;">
			...
			<a href="<%=rootPath %>/otherSchool/importStudents/${classType.id }/${lable }" class="btn btn-primary">继续导入</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="<%=rootPath %>/otherSchool/studentList/${classType.id }/${lable }" class="btn btn-primary">返回</a></div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="<%=rootPath %>/javascripts/class/otherSchool/importlist.js"></script>
