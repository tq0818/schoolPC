    ...
    <div class="mainbackground nopadding">
        ...
        <div class="c-main">
            ...
            <div class="c-content">
                <div class="v-list">
                    <ul>
                    	<c:forEach items="${chapterList }" var="chapter" varStatus="ch_status">
                    		<li class="v-title" chapterId="${cpr.comId }" chapter_id="${ch_status.count }">
	                            <a href="javascript:;">第${ch_status.count}${chapterName}：${chapter.chapterName }</a>
	                        </li>
...
<script type="text/javascript">
	function onsale(){
		$("#onSaleForms").attr("action",rootPath+"/classType/onSale").submit();
	}
</script>
<script type="text/javascript">
        $(function(){
