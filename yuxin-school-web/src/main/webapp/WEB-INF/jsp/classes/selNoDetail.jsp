...
<ul>
	<c:forEach var="c" items="${classVoPage.data }">
	<c:if test="${c.publishStatus == 'MODULE_NO_CREATED' }">
	<li>
	...
	<c:if test="${c.publishStatus == 'MODULE_NO_ON_SALE' }">
	<li>
		<table class="table table-hover table-class">
		<tr>
	        <td width="8%" rowspan="2">
	...
	<c:if test="${c.publishStatus == 'MODULE_NO_OFFLINE' }">
	<li>
		<table class="table table-hover table-class">
		<tr>
	        <td width="8%" rowspan="2">
	...
	<c:if test="${c.publishStatus == 'MODULE_NO_FINISH' }">
	<li>
		<table class="table table-hover table-class">
		<tr>
	        <td width="8%" rowspan="2">
