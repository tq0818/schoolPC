                ...
                <input type="hidden" name="address"/>
                    <ul class="addproxy">
                        <li class="clear">
                            ...
                            <div class="fl">
                                <input type="text" placeholder="这里是代理机构名称" name="name" class="agentName" maxlength="15">
                            </div>
                        </li>
                        <li class="clear">
                            <h4 class="fl">公司名称：</h4>
                            <div class="fl">
                                <input type="text" placeholder="这里是公司名称" name="companyName" class="agentName" maxlength="255">
                            </div>
                        </li>
                        <li class="clear">
                            <h4 class="fl">公司地址：</h4>
                        ...
                        <li class="clear">
                            <h4 class="fl">详细地址：</h4>
                            <div class="fl">
                                <input type="text" name="detailAddress" value="" class="detailAddress" maxlength="220">
                            </div>
                        </li>
                        <li class="clear">
                            <h4 class="fl"><i>*</i>联系人：</h4>
                            <div class="fl">
                                <input type="text" name="contracter" value="" class="contact" maxlength="20">
                            </div>
                        </li>
                        <li class="clear">
                            <h4 class="fl"><i>*</i>手机号码：</h4>
                            <div class="fl">
                                <input type="text" name="contractNumber" value="" class="contact" maxlength="11">
                            </div>
                        </li>
                        <li class="clear">
                            <h4 class="fl">E-mail：</h4>
                            <div class="fl">
                                <input type="text" name="contractEmail" value="" class="contact" maxlength="200">
                            </div>
                        </li>
                        <li class="clear">
                            <h4 class="fl">备注：</h4>
                            <div class="fl">
                                <textarea name="remark1" id="remark" class="detailAddress"></textarea>
                            </div>
                        </li>
                        ...
                        <li class="clear">
                            ...
                            <div class="fl">
                                <input type="text" id="prefix1" name="prefix" value="" class="detailAddress" maxlength="4">
                        ...
                        <li class="clear" id="customsetting">
                            ...
                            <div class="fl percent">
                                <input type="text" value="" name="commissionRate" id="commissionRate" maxlength="11"><span>%</span>
