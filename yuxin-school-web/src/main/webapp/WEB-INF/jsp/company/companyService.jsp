							...
							<li class="clear">
							  <div class="left" style="width: 200px">
			                        <div>
			                            ...
			                            <p class="s-name">
			                                <a href="javascript:void();" onclick="forwardMicroSchool();"> 	 微网校 </a>
								...
								<p class="btns isok">
									<a href="<%=rootPath %>/microSchool/gotoNavigationConfig" class="btn btn-sm btn-default micro-set" >导航配置</a>
									<a href="<%=rootPath %>/microSchool/gotoFooterConfig" class="btn btn-sm btn-default micro-set" >页尾设置</a>
									<a href="<%=rootPath %>/microSchool/gotoCarouselFigureConfig" class="btn btn-sm btn-default micro-set" >轮播图设置</a>
								</p>
							</li>
						  </c:if>
                     </ul>
							...
							<li class="clear">
								  <div class="left" style="width: 200px">
				                        <div>
				                            ...
				                            <p class="s-name">
				                                <a href="javascript:void();" onclick="forwardLive();"> 	 直播 </a>
				                                <c:if test="${!empty manganger }">
									...
									<div class="right server-infos">
										...
										<p class="infos">
											<em style="font-size:14px; width: 85px;margin-top: 3px;">${empty clcn ? 0 : clcn.concurrentMax }</em>下月可用并发<i class="iconfont ask" title="下月可用并发">&#xe60f;</i>
										</p>
									</div>
								</li>
						</c:if>
							...
							<li class="clear">
								<div>
									...
									<%-- <span class="new"></span> --%>
										...
										<i class="icons i4 active" style="cursor: pointer;" onclick="forwardVideo();"></i>
											<p class="s-name">
												<a href="javascript:void(0);" onclick="forwardVideo();">存储</a>
												 <c:if test="${!empty manganger }">
				                                	<i class="iconfont btn-colse-ser" style="color:#dddddd;" title="点击关闭服务" data-type="SERVICE_VIDEO">&#xe635;</i>
				                                </c:if>
									...
									<div class="right server-infos">
										...
										<c:if test="${cms.videoEndDate != null }">
											<em style="font-size:14px;width: 85px; margin-top:3px;"><fmt:formatDate value="${cms.videoEndDate }" pattern="yyyy-MM-dd"/></em>空间到期时间
										</c:if>
										<c:if test="${cms.videoEndDate == null }">
											<em style="font-size:14px;width: 85px; margin-top:3px;"><fmt:formatDate value="${cms.giveVideoStorageDate }" pattern="yyyy-MM-dd"/></em>空间到期时间
										</c:if>
										</p>
									</div>
								</div>
...
<!-- 		                      	 	<span class="new"></span> -->
		                            ...
		                            <p class="s-name">
		                                <a href="javascript:void(0);" onclick="forwardCourse();"> 课程 </a>
		                            </p>
		                        </div>
		                    </div>
		                    <div class="right server-infos">
                ...
                <div class="q-ucont">
                      ...
                      <c:if test="${requestScope.SERVICE_PAY_SET == null }">
                     	<li class="clear">
							<div class="left" style="width: 200px;">
								<div>
								<i class="icons i8 active" style="cursor:pointer;" onclick="forwardPaySet();"></i>
									<p class="s-name">
										<a href="javascript:void(0);" onclick="forwardPaySet();" style="cursor:pointer; text-decoration: none;">支付</a>
									</p>
								</div>
							</div>
							<div class="right server-infos">
							...
							<li class="clear">
								<div class="left" style="width: 200px;">
									...
									<i class="icons i10 active" style="cursor: pointer;" onclick="forwardQuest();"></i>
										<p class="s-name">
											<a href="javascript:void(0);" onclick="forwardQuest();" style="text-decoration: none;">问答社区</a>
											<c:if test="${!empty manganger }">
											<i class="iconfont btn-colse-ser" style="color:#dddddd;" title="点击关闭服务" data-type="SERVICE_QUESTION_ANSWER">&#xe635;</i>
											</c:if>
										</p>
									</div>
								</div>
								...
								<p class="btns isok" style="height:28px">
										<a href="javascript:;" class="btn btn-sm btn-default" data-url="Question/questionSetIndex">设置</a>
									</p>
								</shiro:hasPermission>	
							</li>
						</c:if>
						...
						<li class="clear">
		                    <div class="left" style="width: 200px;">
		                        <div>
		                            <i class="icons i12 active" style="cursor: pointer;" onclick="forwardMarking();"></i>
		                            <p class="s-name">
		                    ...
		                    <p class="btns isok" style="height:28px">
		                        <a href="<%=rootPath %>/companyMarketSet/showCompanyMarket" class="btn btn-sm btn-default">营销QQ</a>
		                        <a href="<%=rootPath %>/companyMarketSet/CompanyMarket_wx" class="btn btn-sm btn-default">微信</a>
		                        <a href="<%=rootPath %>/companyMarketSet/CompanyMarket_wb" class="btn btn-sm btn-default">新浪微博</a>
		                        <a href="<%=rootPath %>/companyMarketSet/CompanyMarket_kf" class="btn btn-sm btn-default">客服电话</a>
		                        <a href="<%=rootPath %>/companyMarketSet/showCompanyMarket" class="btn btn-sm btn-default right-btn more">更多</a>
		                    </p>
		                    </shiro:hasPermission>
		                </li>
		                </c:if>
		                ...
		                <li class="clear">
							<div class="left" style="width: 200px;">
								<div>
								<i class="icons i15 active" style="cursor: pointer;" onclick="forwardSms();"></i>
									<p class="s-name">
								...
								<div class="left" style="width: 200px;">
									...
									<i class="icons i9 active" style="cursor: default;"></i>
										<p class="s-name">
											...
											<c:if test="${!empty manganger }">
											<i class="iconfont btn-colse-ser" style="color:#dddddd;" title="点击关闭服务" data-type="SERVICE_TEACHER">&#xe635;</i>
											</c:if>
										</p>
									</div>
							...
							<li class="clear">
								<div class="left" style="width: 200px;">
									...
									<i class="icons i3 active disable" style="cursor: default;"></i>
										<p class="s-name">
											<a href="javascript:;" style="cursor: default;text-decoration: none;">直播</a>
										</p>
									</div>
								</div>
								<div class="right server-infos">
							...
							<li>
								<div class="left" style="width: 200px;">
									...
									<i class="icons i4 active disable" style="cursor: default;"></i>
										<p class="s-name">
											<a href="javascript:;" style="cursor: default;text-decoration: none;">存储</a>
										</p>
									</div>
								</div>
								<div class="right server-infos">
							...
							<li class="clear">
			                    <div class="left" style="width: 200px;">
			                        <div>
			                            ...
			                            <p class="s-name">
			                                <a href="javascript:void(0);">微网校</a>
			                            </p>
			                        </div>
