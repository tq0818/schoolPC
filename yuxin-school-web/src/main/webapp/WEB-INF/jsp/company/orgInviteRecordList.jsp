...
<body class="q_box overflow-y-h">
            ...
            <div>
                ...
                <div class="recordContent">
                    <div class="screenList screenList-check">
                        ...
                        <input class="nameTel" type="text" placeholder="代理机构名称" />
                    ...
                    <table class="table table-center cashrecord-tab" id="table1">
                        ...
                        <tbody>
                            <tr class="tab-htr">
                                ...
                                <th>
                                    <div class="headClick">
                                        <span mark="inviteNumber">注册学员数量</span>
                                        <p class="sanCon">
	...
	<script src="<%=rootPath%>/javascripts/org_invite.js"></script>
	<script src="<%=rootPath%>/javascripts/orgrecorddetail.js"></script>
</body>
