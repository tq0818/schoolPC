...
<div class="u-wrap company overflow">
    ...
    <div class="right-side">
        <div>
            <div class="title-box">
                <div class="tit-font">
                    <span class="t">个人担保交易</span>
                    <em class="iconfont help-font" onclick="javascript:window.open('<%=rootPath%>/payConfig/howPayTwo')">&#xe621;</em>
                    <div class="help-pop">如何开通个人担保交易</div>
                </div>
            </div>
...
<input type="hidden" id="saveType" value="PAY_TYPE_GRDB">
