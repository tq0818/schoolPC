    ...
    <div class="mainbackground nopadding">
     <div class="heading" style="padding: 0px 0px;">
            ...
            <span class="line"></span>
     		...
     		<input type="hidden" value="${stageId }" id="stageId"/>
...
<!-- 		        </div> -->
		...
		<div style="text-align: center;"><a href="javascript:;" class="btn btn-primary signUpMany">批量报名</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=rootPath %>/classPackage/importPage/${packageId}" class="btn btn-primary">继续导入</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=rootPath %>/classPackage/studentList/${packageId}" class="btn btn-primary">返回</a></div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="<%=rootPath %>/javascripts/class/cousePackage/importlist.js"></script>
