...
<%@include file="/WEB-INF/jsp/coursePackage/commonTitle.jsp" %><!-- 页头 -->
<!-- ajax加载中div开始 -->
...
<input id="classPackageId" type="hidden" value="${classPackageId}">
    <div class="right-side">
        <div class="u-wrap classes">
            <div class="mainbackground nopadding">
                <div class="heading">
                    <h2 class="h5">${cpRecord.name}-上课情况</h2>
                ...
                <div class="table-box t-table-box">
                    <table>
                        ...
                        <tr>
                            <td>${cpRecord.precent}%</td>
                            <td>${cpRecord.registTime}</td>
                            <td>${cpRecord.applyTime}</td>
                            <td>${cpRecord.questionNum==null?0:cpRecord.questionNum}次</td>
                            <td>${cpRecord.evaluateNum==null?0:cpRecord.evaluateNum}次</td>
                        </tr>
                    </table>
...
<script type="text/javascript" src="<%=rootPath%>/javascripts/class/cousePackage/packageLeanRecard.js"></script>
