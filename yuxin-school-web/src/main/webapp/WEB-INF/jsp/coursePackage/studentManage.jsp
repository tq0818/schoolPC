...
<div class="u-wrap company overflow">
    ...
    <div class="right-side" style="background-color: white;">
		    ...
		    <div class="mainbackground nopadding" style="min-height: 546px;">
		        ...
		        <div>
		            <input type="hidden" id="packageId" name="commodityId" value="${classPackage.id }" />
...
<script type="text/javascript" src="<%=rootPath %>/javascripts/class/cousePackage/studentlist.js"></script>
