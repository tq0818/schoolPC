...
<div class="left-side">
    ...
    <ul id="course_manage" class="system_managelist">
        ...
        <li class="subentry" code="classManagerGetClassList" mark="/classManager/getClassList">课程管理</li>
        ...
        <li class="subentry" code="classQueryGetClassList" mark="/classQuery/getClassList">分校课程查询</li>
