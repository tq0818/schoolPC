...
<body>
<%@include file="/WEB-INF/jsp/menu/menu_statistics.jsp"%>
<div class="statistical-box">
	<span class="scount fl">· 成都数字学校<i class="c_red">注册人数总计</i>：<b>${allStuNum}</b>人</span>
	<span class="scount fr">· 成都数字学校<i class="c_red">教育信息完善人数总计</i>：<b>${completeStuNum}</b>人</span>
</div>
		...
		<div class="biaoge-coment biaoge-left fl wit50">
			<div class="biaoge-cont">
				<div class="block-title">
					<h3>学员趋势图</h3>
					<span class="more"><a href="<%=rootPath %>/query/statistics/studentList" style="color: #00b7ee; text-decoration:none;">更多</a></span>
			</div>
		...
		<div class="biaoge-coment biaoge-left fr wit50">
			<div class="biaoge-cont">
				<div class="block-title">
					...
					<span class="more"><a href="<%=rootPath %>/query/statistics/queryOrg" style="color: #00b7ee; text-decoration:none;">更多</a></span>
				</div>
