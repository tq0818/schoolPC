...
<body>
<%@include file="/WEB-INF/jsp/menu/menu_statistics_org.jsp"%>
<div class="statistical-box">
	<span class="scount fl">· 成都数字学校<i class="c_red">${schoolDict}注册人数总计</i>：<b>${allStuNum}</b>人</span>
	<span class="scount fr">· 成都数字学校<i class="c_red">${schoolDict}教育信息完善人数总计</i>：<b>${completeStuNum}</b>人</span>
</div>
		...
		<div class="biaoge-coment biaoge-left fr wit50">
			<div class="biaoge-cont">
				<div class="block-title">
					...
					<span class="more"><a href="<%=rootPath %>/query/orgstatistics/queryOrg" style="color: #00b7ee; text-decoration:none;">更多</a></span>
				</div>
