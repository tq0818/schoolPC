	...
	<div class="u-wrap query overflow">
		...
		<div class="right-side set-system gg-biaoge">
			<div class="mainbackground nopadding">
				<div class="heading">
					<h2 class="h5">${area.itemValue}学校教育信息完善情况</h2>
	...
	/*	function $selectThirdMenu(code) {
		...
		function queryPerfect2(){
			...
			$.ajax({
				...
				data:{'eduArea':'${area.itemCode}', 'eduStep':eduStep},
				dataType:'json',
				type:'post',
			...
			$(document).statistical({}).queryPerfect2('${area.itemCode}', eduStep);
		}
	</script>
</body>
</html>