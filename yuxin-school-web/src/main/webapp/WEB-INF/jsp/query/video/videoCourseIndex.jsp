...
<script type="text/javascript">
	...
	function searchTotleVideoCourse(){
	...
	function searchTotleVideoCourse2(){
    ...
    function searchTotleVideoCourse3(){
        var dataKey = new Array(),dataValue = new Array();
        $.ajax({
    ...
    function searchTotleVideoCourse4(){
        $.ajax({
                ...
                if(result!=null && result.length>0){
                    for(var j=0; j<result.length; j++){
                        for(var k in result[j]){
                            ...
                            $(".statistics-con").append('<div class="demand-count" style="width:100%;height: 120px;"></div>');
	...
	searchTotleVideoCourse();//查询所有的学生
	searchTotleVideoCourse2();//按照学校性质赛选
    searchTotleVideoCourse3();//观看点播前五学校
    searchTotleVideoCourse4();//观看学科前三学校
