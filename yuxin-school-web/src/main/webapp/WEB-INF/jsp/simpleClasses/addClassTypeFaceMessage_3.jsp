    ...
    <div class="nopadding">
        <div class="steps">
            ...
            <ul class="clear">
                ...
                <li class="step2 s2 active">
                    <i>02</i>
                    <em>课程详细</em>
                </li>
                <li class="step2 s3 hover">
                    <i>03</i>
                    <em>安排课表</em>
                </li>
            </ul>
			...
			<div class="form-body">
				...
				<div class="form-group">
					...
					<div class="col-md-4" id="classcontent">
				    	...
				    	<span class="nullnum1 none" style="width:auto; color:red;">没有数据，<a href="javascript:void(0);" class="addC">去设置</a></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8" id="tcontent">
		            	...
		            	<span class="nullnum2 none" style="width:auto;color:red;">没有数据，<a href="javascript:void(0);" class="addTL">去设置</a></span>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-8" id="tcontent1">
		            	...
		            	<span class="nullnum3 none" style="width:auto;color:red;">没有数据，<a href="javascript:void(0);" class="addT">去设置</a></span>
					</div>
				</div>
				<div class="form-group">
...
function guid() {
	...
	<script type="text/javascript" src="<%=rootPath %>/javascripts/simpleclasses/classTypesimpleface.js"></script>
