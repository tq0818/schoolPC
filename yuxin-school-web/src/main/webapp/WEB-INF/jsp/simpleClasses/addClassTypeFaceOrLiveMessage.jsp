...
<div class="u-wrap classes">
    <div class="mainbackground nopadding">
        ...
        <input type="hidden" name="ltype" value="live"></input>
        <input type="hidden" name="courseNum" value="99"></input>
        <div class="c-main">
            <div class="c-content">
                <p class="c">
               ...
               <c:if test="${not empty isArea and '0' ne isArea }">
               		<p class="c ">
	                    ...
	                    <span class="c-content" style="color:black;">
	                     	...
	                     	<input type="radio" <c:if test="${classType.isPublic ne 0 }">checked="checked"</c:if>  value="1" name="isPublic">是
                        	<input type="radio" <c:if test="${classType.isPublic eq 0 }">checked="checked"</c:if> value="0" name="isPublic">否
	                    </span>
	               </p>
