...
<%@include file="/decorators/import.jsp" %>
    ...
    $(document).ready(function(){
    	...
    	$(".nextaction").on('click',function(){
    		window.location.href=rootPath+"/simpleClasses/addliveOrface/"+$("#classTypeId").val()+"?type="+$("#tlable").val()+"&ftype="+$("#cType").val();
    	});
    });
    //改变标题栏
function guid() {
	...
	function changeTitle(){
		...
		if(b.length==2){
            ...
            '<li class="step5 s3 hover"><i>03</i><em>安排视频</em></li>'+
...
<form method="post" id="myForms">
	...
	<input type="hidden" name="type1" id="tlable" value="${type }"/>
...
<div class="u-wrap classes">
    ...
    <div class="heading">
      ...
      <!--   <div class="q-btns" style="text-align:center;">
                    ...
                    <a href="javascript:void(0);" id="next1" class="q-save next">下一步</a>
                </div>  -->  
    </div>
     <div class="btns" style="text-align:center;padding:20px 0 0 0;">
    	<a href="javascript:backReturn();" class="btn btn-primary">返回</a>
    	<a href="javascript:;" class="btn btn-primary nextaction">下一步</a>
    	<a href="javascript:;" class="btn btn-default cancle">取消</a>
    </div>
</div>
