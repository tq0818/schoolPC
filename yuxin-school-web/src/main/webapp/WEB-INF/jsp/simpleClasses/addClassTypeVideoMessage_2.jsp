...
input+span{
    ...
    <script type="text/javascript">
		...
		//返回按钮
		function backReturn(){
			$("#myForm").attr("action",rootPath+"/simpleClasses/editClassTypeMessage").submit();
		}
	</script>
</head>
...
<div class="u-wrap classes">
    <div class="nopadding">
        <div class="steps">
            <div class="line"></div>
            <ul class="clear">
               <li class="step2 s1 active">
                    <i>01</i>
                    <em>基本信息</em>
                </li>
                <li class="step2 s2 hover">
                    <i>02</i>
                    <em>课程详情</em>
                </li>
                <li class="step2 s3">
        ...
        <div class="c-main">
            <div class="c-content">
                ...
                <p class="c text-center" style="margin-top: 10px;">
                    <a href="javascript:backReturn();" class="btn btn-default">上一步</a>
                    <a href="javascript:save('saveandtui');" class="btn btn-primary">保存并退出</a>
                    <a href="javascript:save('save');" class="btn btn-primary">保存并继续</a>
...
<div class="add-layer w900 none" style="z-index:1001;width:800px;height:460px;">
    <i class="iconfont close">&#xe610;</i>
    <div class="layer-content">
        <div class="term">
            <span class="term-title">题库</span>
            <span class="term-title">
                <select name="" id="choose_tiku" style="max-width: 150px;">
                </select>
            </span>
            <span class="term-title">科目</span>
            <span class="term-title">
                <select name="" id="choose_item" style="max-width: 150px;">
                </select>
            </span>
            <span class="term-title">试卷名称</span>
            <span class="term-title">
                <input type="text" id="choose_paper" style="width: 150px;height:22px;"/>
            </span>
            <span style="float:right;margin-right:50px;">
                <input type="button" class="btn btn-sm btn-default" id="search_paper" value="搜索">
            </span>
        </div>
        ...
        <table class="table table-center table-head">
                <tbody>
	                <tr class="head">
	                    <th style="width:30%;">试卷名称</th>
	                    <th style="width:30%;">所属题库</th>
	                    <th style="width:20%;">所属科目</th>
	                    <th style="width:20%;">试卷类型</th>
	                </tr>
            	</tbody>
            </table>
        	<div class="table-list">            
...
<div class="add-layer w1000 none" style="z-index:1001;width:800px;height:460px;">
    <i class="iconfont close">&#xe610;</i>
    <div class="layer-content">
        <div class="term">
            <span class="term-title">学科</span>
            <span class="term-title">
                <select name="" id="choose_itemOne">
                </select>
            </span>
            <span class="term-title">学科小类</span>
            <span class="term-title">
                <select name="" id="choose_itemSecond">
                </select>
            </span>
            <span class="term-title">上传时间</span>
            <span class="term-title">
                <input type="text" id="start_date" class="date-picker" placeholder="起始时间">
            </span>
            <span class="term-title">至</span>
            <span class="term-title">
                <input type="text" id="end_date" class="date-picker" placeholder="结束时间">
            </span>
        </div>
