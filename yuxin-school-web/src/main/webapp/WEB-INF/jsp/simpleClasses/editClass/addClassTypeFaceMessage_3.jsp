...
<!--                      	</li> -->
                ...
                <p class="c text-center" style="margin-top:20px;">
                    <a href="javascript:save();" class="btn btn-primary" style="margin-right:20px">保存</a>
...
<div class="layer-tips class-resource" id="class-resource" style="height: auto;width:500px;">
	<div class="layer-tips-content">
	    ...
	    <p>
	    	课程资料：
<!-- 			<span class="upfile">  -->
<!-- 				<input type="file" lecid="" id="doctype" url="" mark="" cname="" name="doc" class="up-input" accept=".doc,.pdf,.xls,.ppt,.docx,.pptx,.xlsx,.zip,.rar" onchange="javascript:docChange();"> -->
