        ...
        <div class="c-main">
        	<div>
        		<span id="course_typeLists">
        			<c:choose>
        				<c:when test="${ftype=='live,face'}">
        					<a href="javascript:;" mark="TEACH_METHOD_LIVE" class="btn btn-default btn-primary">直播</a>
        					<a href="javascript:;" mark="TEACH_METHOD_FACE" class="btn btn-default">面授</a>
        				</c:when>
        				<c:when test="${ftype=='live' }">
        					<a href="javascript:;" mark="TEACH_METHOD_LIVE" class="btn btn-default btn-primary">直播</a>
        				</c:when>
        				<c:otherwise>
        					<a href="javascript:;" mark="TEACH_METHOD_FACE" class="btn btn-default btn-primary">面授</a>
        				</c:otherwise>
        			</c:choose>
		...
		<div class="main form-horizontal">
			<div class="form-body">
				...
				<div class="form-group" id="barrage">
					<label class="col-md-2 control-label">是否开启弹幕</label>
					<div class="col-md-8">
						<input type="radio" value="1" name="barrage"/>是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" value="0" checked="checked" name="barrage"/>否&nbsp;&nbsp;&nbsp;<span style="color:red;"></span>
					</div>
				</div>
...
<!-- 上传课程资料弹层信息 -->
<div class="layer-tips class-resource" id="class-resource" style="height: 260px;width:500px;">
