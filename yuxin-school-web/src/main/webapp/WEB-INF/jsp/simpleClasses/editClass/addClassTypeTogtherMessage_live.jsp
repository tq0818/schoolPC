        ...
        <div class="c-main">
        	<div>
        		<span id="course_typeLists">
        			<a href="javascript:;" style="display: none;" mark="TEACH_METHOD_LIVE" class="btn btn-default btn-primary">直播</a>
        		</span>
	...
	<div class="popupwin onepopuwin add-fix" data-pupwin="modal" style="top:20%;left:18%;width:55%;height:auto;">
		...
		<div class="main form-horizontal">
			<div class="form-body">
				...
				<div class="form-group none" id="mobilesupports">
					<label class="col-md-2 control-label">是否支持移动端</label>
					<div class="col-md-8">
						<input type="radio" value="1" name="supportMobile" id="supportY"/>是&nbsp;&nbsp;&nbsp;&nbsp;<input id="supportN" type="radio" value="0" checked="checked" name="supportMobile"/>否&nbsp;&nbsp;&nbsp;<span style="color:red;">排课后不可修改, 需要使用直播助手和桌面共享的方式进行上课。</span>
					</div>
				</div>
				<div class="form-group none" id="liveClassTypeFlags">
				...
				<div class="form-group none" id="barrage">
				...
				<div class="form-group none" id="modetype">
