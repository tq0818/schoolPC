				...
				<c:if test="${sgOpen==1 }">
					<div class="form-group">
						...
						<div class="col-md-2" style="width: 350px;">
				        	...
				        	<select id="studentG2_add" name="studentGroup2_add">
				        	</select>
						</div>
					</div>
				</c:if>
				...
				<c:if test="${sgOpen==1 }">
					<div class="form-group">
						...
						<div class="col-md-2" style="width: 350px;">
				        	...
				        	<select id="studentG2_edit" name="studentGroup2_edit">
				        	</select>
						</div>
					</div>
				</c:if>
...
<!-- popupwin 修改密码界面结束 -->
<script type="text/javascript" src="<%=rootPath %>/javascripts/student/full/studentlist-full.js"></script>
