...
<div class="m-b-p clear" >
        ...
        ">
            ...
            <div class="btns">
                <a href="javascript:void(0);" onclick="returnFee(${payMaster.id})" class="m-btn">退费</a>
                <a href="javascript:void(0);" onclick="changeClass(${payMaster.id})" class="m-btn">转班</a>
                <a href="javascript:void(0);" onclick="changeStudent(${payMaster.id})" class="m-btn m-mb">转人</a>
    ...
    <form action="<%=request.getContextPath() %>/student/selectEntryDetail" id="toDetailForm" method="post">
    <input type="hidden" id="payMasterId" name="payMasterId"/>
    </form>
</c:forEach>
<script type="text/javascript" src="<%=rootPath %>/javascripts/student/transaction/ajaxEntryMessage.js"></script>