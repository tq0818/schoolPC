		...
		<div class="main-content payInfo">
			...
			<div class="pay-list clear">
				<div class="pay-order">
					...
					<span><input type="radio" name="payType" value="STAGE"> 分期 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="stageNum none"> 共分 <input id="val_total_stage" maxlength="2" class="sm" type="text" value="">期</span></span>
					</shiro:hasPermission>
				</div>
