...
<link rel="stylesheet"  type="text/css" href="<%=rootPath %>/stylesheets/manage.css">
	...
	<script type="text/javascript" src="<%=rootPath %>/javascripts/student/full/transaction/changeStudent.js"></script>
					...
					<li class="long">
						<p class='c'>
							...
							<span class="c-content">
								<input type="text" id="mb" class="input-ctrol"> 
								<input type="button" class="btn btn-default btn-sm" onclick="query();" value="查询">
