        ...
        <div class="add-news">
          <div class="">
            ...
            <p class="c">
                ...
                <span class="c-content">
                   <input type="text" style="width:83px; min-width: auto;" onkeyup="onlyNonNegative(this)"  class="long-title" id="readBaseIndex" name="readBaseIndex" value="${sysNews.readBaseIndex }"/>
                </span>
            </p>
           </div>
            <div class="c">
