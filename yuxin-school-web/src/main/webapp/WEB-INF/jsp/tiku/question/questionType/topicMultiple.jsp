        ...
        <c:if test="${topicVo == null }">
            <div class="qution-control option-div">
                ...
                <span class="qution-input quesOption">
                    ...
                    <label class="q-i-i">
                        <input type="checkbox" name="answer" value="A"> 设为正确答案
            ...
            <div class="qution-control option-div">
                ...
                <span class="qution-input quesOption">
                    ...
                    <label class="q-i-i">
                        <input type="checkbox" name="answer" value="B"> 设为正确答案
                        <i class="iconfont i-del">&#xe626;</i>
            ...
            <div class="qution-control option-div">
                ...
                <span class="qution-input quesOption">
                    ...
                    <label class="q-i-i">
                        <input type="checkbox" name="answer" value="C"> 设为正确答案
                        <i class="iconfont i-del">&#xe626;</i>
            ...
            <div class="qution-control option-div">
                ...
                <span class="qution-input quesOption">
                    ...
                    <label class="q-i-i">
                        <input type="checkbox" name="answer" value="D"> 设为正确答案
                        <i class="iconfont i-del">&#xe626;</i>
			...
			<c:forEach var="o" items="${topicVo.option }" varStatus="status">
	            ...
	            <div class="qution-control option-div">
	                ...
	                <span class="qution-input quesOption">
	                    ...
	                    <label class="q-i-i">
	                        <input type="checkbox" name="answer" value="${o.optionNo }" checked="checked" data-id="${o.id }"> 设为正确答案
	                        <i class="iconfont i-del">&#xe626;</i>
	            ...
	            <div class="qution-control option-div">
	                ...
	                <span class="qution-input quesOption">
	                    <input type="text" value="${o.optionName }" data-select="${o.optionNo }">
	                    <label class="q-i-i">
	                        <input type="checkbox" name="answer" value="${o.optionNo }" data-id="${o.id }"> 设为正确答案
	                        <i class="iconfont i-del">&#xe626;</i>
	                        <i class="iconfont i-edit" data-select="${o.optionNo }" style="font-size:12px;">&#xe628;</i>
	                    </label>
	                </span>
