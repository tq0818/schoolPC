...
<link rel="stylesheet" type="text/css" href="<%=rootPath%>/stylesheets/css/login.css" />
...
<body>
	<header>
    	<div class="LV-header"></div>
	</header>
	<!-- header start -->
		<div class="header">
			<a href="/" title="" class="navbar-brand" ><img _src="<%=rootPath%>/images/logo-2.png" height="50"></a>
		</div>
	<!-- header end -->
	<div class="main">
		<div class="content">
			...
			<div class="box">
				...
				<form class="login-form" action="<%=rootPath%>/campaignLogin" method="post">
