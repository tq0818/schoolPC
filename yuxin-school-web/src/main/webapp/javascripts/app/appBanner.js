...
//异步加载数据
function queryCycleData(e){
	var schoolId=$(e).find("option:selected").val();
	if(!schoolId || schoolId==""){
		schoolId=$("#schoolList").val();
	}
	 $.ajax({ 
		  type: "post", 
		  url: rootPath+"/sysCyclePic/queryAppCycleList", 
		  data:{"schoolId":schoolId, "picType":"app"},
		  success: function(result){
...
//		clickUrl="http://"+clickUrl;
	...
	$.ajax({
		...
		data : {"clickUrl" :clickUrl,"validFlag" : valid_flag,"schoolId":schoolId,"picUrl":picUrl, "picType":"app"},
		success: function(result){
			queryCycleData();
			$("#cycleUrl").val('');
