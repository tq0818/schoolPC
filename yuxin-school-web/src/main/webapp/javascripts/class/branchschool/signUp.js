...
//			payMaster.itemOneId=$("#stuItemOneId").val();
//			payMaster.itemOneName=$("#stuItemOneName").val();
//			payMaster.itemSecondId=$("#stuItemSecondId").val();
//			payMaster.itemSecondName=$("#stuItemSecondName").val();
//			payMaster.classTypeId=$("#stuClassTypeId").val();
//			payMaster.classTypeName=$("#stuClassTypeName").val();
...
//			payMaster.classTypeHour=$("#stuTotalClass").val();
									...
									success : function(payMaster){
										...
										if($this.options.ns){
						    				$.alert("报名成功，同时为该学员生成了网校的账户，账户名称是学员的手机号，初始密码是手机号后六位，已通过短信形式通知学员",function(){
							    				location.href=rootPath+"/branchSchool/studentList/"+$("#stuClassTypeId").val()+"/"+$("#lable").val();
							    			})
						    			}else{
