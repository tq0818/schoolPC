	...
	var Form={
			init : function(){
				...
				$(".addbtn").on('click',function(){
					...
					location.href=rootPath+"/classModuleNo/addModuleNo/"+id+"/"+$(this).attr("ids")+"/"+lable;
//					$(".layout-choose").removeClass("none");
//					$(".layout-mb").removeClass("none");
//					window.open(rootPath+"/classModuleNo/addModuleNo/"+id+"/"+$(this).attr("ids")+"/"+lable);
				})
...
//					$(".layout-choose").removeClass("none");
//					$(".layout-mb").removeClass("none");
					location.href=rootPath+"/classModuleNo/editModule/"+$(this).attr("ids")+"?classTypeId="+id+"&methed="+lable;
					//链接地址
