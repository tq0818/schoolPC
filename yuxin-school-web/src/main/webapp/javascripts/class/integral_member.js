$(document).ready(function(){
	 $.ajax({
			...
			success : function(result) {
				if(result=="hide"){
					...
					$.ajax({
						url : rootPath + "/companyIntegralConfig/queryIntegralConfig",
						type : "post",
						success : function(result) {
							if(result){
	 ...
	 //课程购买人数设置
	 $.ajax({
			url : rootPath + "/companyFunctionSet/buySet",
			type : "post",
			success : function(result) {
	 ...
	 $.ajax({
			...
			success : function(result) {
				if(result=="hide"){
					...
					$.ajax({
						url : rootPath + "/companyMemberConfig/queryMemberConfig",
						type : "post",
						success : function(result) {
							if(result){
...
//							}
	 ...
	 $.ajax({
			...
			type : "post",
			data : {"classTypeId":$("#classtypeIds").val()},
