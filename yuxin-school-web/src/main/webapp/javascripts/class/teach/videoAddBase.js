			...
			$(".btn-ok").on('click',function(){
    			...
    			if(docurl == null || docurl == ""){
					...
					$.ajax({
						...
						type:"post",
						data:{"itemOneId":oneItem,"itemSecondId":twoItem,"classTypeId":classid,"resourceType":resource,"classTypeName":classTypeName,"name":docname,"size":docsize,"resName":resName,"lectureId":lectureId,"fileId":docurl,"lectureType":"TEACH_METHOD_VIDEO"},
						dataType:"json",
						success:function(data){
							if(data.msg == "success"){
								$(".class-resource").hide();
