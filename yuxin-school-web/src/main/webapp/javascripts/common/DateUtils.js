var DateUtil = function(){
    ...
    this.dateToStr = function(formatStr, date){
        ...
        str=str.replace(/dd|DD/,date.getDate()>=10?date.getDate().toString():'0' + date.getDate());  
    ...
    */
     ...
     * 获取小时差，保留一位小数
     */
    this.timeDifference = function(begin,end){
    	var time,hour,min,ss,str;
		time = parseInt(this.longToDate(end) - this.longToDate(begin));
