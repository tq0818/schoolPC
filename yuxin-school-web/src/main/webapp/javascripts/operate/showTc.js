	...
	$.fn.showTc=function(opt){
		...
		return this.each(function(){
			...
			function js(){
				...
				$this.css({"position":position,"z-index":99,"left":left,"top":top});
				$(".tcBg").css({width:bgWidth,height:bgHeight});
			}
			js();
			var bg='<div class="tcBg" style="display:none;width:'+bgWidth+';height:'+bgHeight+';position:'+position+';background:'+option.backgroundColor+';opacity:'+option.option+';filter:alpha(opacity='+option.option*100+');z-index:'+98+';left:0;top:0;"></div>';
			var closeBtn=$this.find(".close,#btn-cancel");
