	...
	var Form={
			init : function(){
				...
				$("#ltype").on('click','a.btn',function(){
					...
					if(b.length==2){
						if(b[0]=="face"){
							headHtml1='<li class="step s1 hover"><i>01</i><em>基本信息</em></li>'+
			                    '<li class="step s2"><i>02</i><em>课程详情</em></li>'+
			                    '<li class="step s3"><i>03</i><em>安排视频</em></li>'+
			                    '<li class="step s4"><i>04</i><em>安排直播</em></li>';
						}else if(b[0]=="live"){
							headHtml1='<li class="step s1 hover"><i>01</i><em>基本信息</em></li>'+
		                    '<li class="step s2"><i>02</i><em>课程详情</em></li>'+
		                    '<li class="step s3"><i>03</i><em>安排视频</em></li>'+
							...
							headHtml1='<li class="step s1 hover"><i>01</i><em>基本信息</em></li>'+
		                    '<li class="step s2"><i>02</i><em>课程详情</em></li>'+
		                    '<li class="step s3"><i>03</i><em>安排直播</em></li>'+
		                    '<li class="step s4"><i>04</i><em>安排面授</em></li>';
						}
					}else if(b.length==3){
						if(b[0]=="video"&&b[1]=="live"){
							headHtml1='<li class="step2 s1 hover"><i>01</i><em>基本信息</em></li>'+
		                    '<li class="step2 s2"><i>02</i><em>课程详情</em></li>'+
		                    '<li class="step2 s3"><i>03</i><em>安排面授</em></li>';
						}else if(b[0]=="video"&&b[1]=="face"){
							headHtml1='<li class="step2 s1 hover"><i>01</i><em>基本信息</em></li>'+
		                    '<li class="step2 s2"><i>02</i><em>课程详情</em></li>'+
		                    '<li class="step2 s3"><i>03</i><em>安排直播</em></li>';
						}else if(b[0]=="live"&&b[1]=="face"){
							headHtml1='<li class="step2 s1 hover"><i>01</i><em>基本信息</em></li>'+
		                    '<li class="step2 s2"><i>02</i><em>课程详情</em></li>'+
		                    '<li class="step2 s3"><i>03</i><em>安排视频</em></li>';
						}
					}else if(b.length==4){
						headHtml1='<li class="step3 s1 hover"><i>01</i><em>基本信息</em></li>'+
	                    '<li class="step3 s2"><i>02</i><em>课程详情</em></li>';
					}else{
						headHtml1='<li class="step5 s1 hover"><i>01</i><em>基本信息</em></li>'+
	                    '<li class="step5 s2"><i>02</i><em>课程详情</em></li>'+
	                    '<li class="step5 s3"><i>03</i><em>安排视频</em></li>'+
	                    '<li class="step5 s4"><i>04</i><em>安排直播</em></li>'+
	                    '<li class="step5 s5"><i>05</i><em>安排面授</em></li>';
					}
					$("ul.clear").html("").append(headHtml1);
				});
	                		...
	                		success:function(b){
	                			if(b){
	        				    	...
	        				    	Form.updateCourseMember($("#classtypeIds").val(),function(){
	        				    		$("#addFormOne").attr("action",rootPath+"/simpleClasses/updateClassTypeMessage").submit();
    								});
	                			}else{
			    	...
			    	if($("#addFormOne").valid()){
			    		$.ajax({
	                		...
	                		success:function(b){
	                			if(b){
	                				$.ajax({
	        							url : rootPath+"/simpleClasses/addBaseInfo",
	        							type : "post",
	        							...
	        							success : function(ct) {
	        								...
	        								Form.updateCourseMember(ct.id,function(){
	        									$("#addFormOne").attr("action",rootPath+"/simpleClasses/addClassPackage").submit();
	        								});
	        							}
	        						});
	                			}
