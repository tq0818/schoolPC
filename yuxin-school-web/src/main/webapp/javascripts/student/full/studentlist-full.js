	...
	var Link = {
			init : function () {
				$(".user-list").on("click",".showSignUp",function(){
					...
					var form =document.createElement("form");
					document.body.appendChild(form);
					form.action=rootPath + '/student/full/showSignUp';
					form.method="post";
					form.target="_self";
					var fileName=document.createElement("input");
					fileName.type='hidden';
				...
				.on("click",".toTransaction",function(){
	                ...
	                if(!mobile || mobile==""){
					 ...
					 var form =document.createElement("form");
						document.body.appendChild(form);
						form.action=rootPath + '/student/full/toTransaction';
						form.method="post";
						form.target="_blank";
						var fileName=document.createElement("input");
						fileName.type='hidden';
...
//				$(".user-list").on("mouseover",".more",function(){
//					 $(this).next().show();
//				})
	            ...
	            $(".user-list").on("click", ".updateStudentMsg", function () {
	                ...
	                $.ajax({
	                    ...
	                    success: function (jsonData) {
	                        ...
	                        $("#uAddress").cityselect({
	            				url:rootPath + "/javascripts/company/city.min.js",
	            			    prov:jsonData.province, //省份 
	            			    city:jsonData.city,
	            			    dist: jsonData.county,//市
	            			    nodata:"none" //当子集无数据时，隐藏select
	            			});
