...
CKEDITOR.dialog.add('questionFilling', function(editor) {
    ...
    var makeBlankInput = function(value) {
        ...
        var html = '<table class="cke_dialog_ui_hbox" data-role="input-row" style="margin-bottom:10px;">' + '  <tr class="cke_dialog_ui_hbox">' + '    <td class="cke_dialog_ui_hbox_first" style="width:85%">' + '      <input type="text" class="qb-input cke_dialog_ui_input_text" value="' + value + '" id=qb-input-' + inputId + '>' + '    </td>' + '    <td class="cke_dialog_ui_hbox_last" style="width:15%">' + '      <a href="javascript:;" class="cke_dialog_ui_button" data-role="delete"><span class="cke_dialog_ui_button">删除</span></a>' + '    </td>' + '  </tr>' + '</table>';
        return html;
    };
    ...
    return {
        ...
        contents: [{
            ...
            elements: [{
                ...
                id: 'hint',
                type: 'html',
                html: '<span style="color: #F70B0B;">提示：点击 [添加]按钮，为填空同时设置多个答案</span>'
            }]
        }],
